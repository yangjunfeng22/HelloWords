...
//        NSString *todayStr = NSLocalizedString(@"今天", @"");
//        NSString *today = [NSString stringWithFormat:@"%@ HH:mm",todayStr];
    ...
    // 3.显示日期
    NSString *lastStr = NSLocalizedString(@"最后更新", @"");
    self.lastUpdateTimeLabel.text = [NSString stringWithFormat:@"%@：%@",lastStr, time];
}
