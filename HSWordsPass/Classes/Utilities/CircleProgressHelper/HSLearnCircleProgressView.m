...
- (void)setGroundTintColor:(UIColor *)groundTintColor
{
    if (![self.groundTintColor isEqual:groundTintColor])
    {
        HSLearnCircleProgressLayer *layer = (HSLearnCircleProgressLayer *)self.layer;
        layer.groundTintColor = groundTintColor;
        [layer setNeedsDisplay];
    }
}
...
- (UIColor *)groundTintColor
{
    HSLearnCircleProgressLayer *layer = (HSLearnCircleProgressLayer *)self.layer;
    return layer.groundTintColor;
}
